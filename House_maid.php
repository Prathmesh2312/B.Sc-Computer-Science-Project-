...
<head>
    ...
    <link rel="stylesheet" href="House_maid.css">
</head>
...
<header>
    ...
    <div class="housemaid">
        <h2 class="h1"><span>House Maid</span></h2>
        ...
        <div class="card-group">
            ...
            <div class="card6" style="width: 18rem;">
                ...
                <div class="card-body-6">
                    ...
                    <br>
                    <br>
                    <h5 class="card-title-5">Easily find trusted homemakers</h5>
                    <p class="card-text-5">With HomeMaid Connect, you can browse and connect with verified homemakers who provide quality services for household chores.</p>
                </div>
            </div>
            <div class="card7" style="width: 18rem;">
                <img src="Support.jpg" class="card-img-top" alt="...">
                <div class="card-body-7">
                    <h5 class="card-title-5">Save time and effort</h5>
                    <p class="card-text-5">Our platform takes the hassle out of the search for a reliable homemaid. We provide a simple and easy-to-use platform that connects you with homemakers who are professionally trained and background checked</p>
                </div>
            </div>
        </div>
    </div>
