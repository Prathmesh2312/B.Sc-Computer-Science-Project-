...
<body>
        ...
        <span>
            <div class="card w-50" style="max-width: 350px;">
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Domestic Help</h5>
                            <p class="card-text">Choose a combination of cooking, baby care, odd jobs, cleaning,
                                etc!
                            </p>
                            <a href="Domestic_helper.php" class="card-link">See more</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <span>
            <div class="card1 w-50" style="max-width: 350px;">
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Baby Caretaker</h5>
                            <p class="card-text">Experienced babysitters and japa for all your child-care needs!
                            </p>
                            <a href="Baby_Caretaker.php" class="card-link">See more</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <a href="Cooking_maid.php" class="card-link">See more</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <a href="House_maid.php" class="card-link">See more</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="feedback">
        <br><br>
        <p>"I have been using HomeMaid Connect for more than<br> a month now and have never been disappointed.
            The<br>
            platform
