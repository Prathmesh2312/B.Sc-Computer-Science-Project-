...
<head>
    ...
    <title>Domestic Helper</title>
    <link rel="stylesheet" href="Domestic_helper.css">
</head>
...
<header>
    ...
    <div class="housemaid">
        <h2 class="h1"><span>Domestic Help</span></h2>
        <p class="descriptionHouse">Book a professional Domestic Helper for your daily chores</p>
        ...
        <div class="card-group">
            <div class="card5" style="width: 18rem;">
                ...
                <div class="card-body-5">
                    <h5 class="card-title-5">House Cleaning</h5>
                    <p class="card-text-5">Our meticulous house cleaners are skilled in creating a spotless and inviting living space. They will dust, vacuum, mop, and scrub every corner of your home, paying attention to even the tiniest details. With our house cleaning service, you can enjoy a pristine and welcoming atmosphere without the hassle.</p>
                </div>
            </div>
            <div class="card6" style="width: 18rem;">
                ...
                <div class="card-body-6">
                    ...
                    <br>
                    <br>
                    <h5 class="card-title-5">Event Planning and Hosting</h5>
                    <p class="card-text-5">From intimate gatherings to grand celebrations, our event planning experts will help you create memorable experiences. We'll handle every aspect, including venue selection, catering, decor, and coordination, so you can relax and enjoy being a gracious host.</p>
                </div>
            </div>
            <div class="card7" style="width: 18rem;">
                <img src="Support.jpg" class="card-img-top" alt="...">
                <div class="card-body-7">
                    <h5 class="card-title-5">Personal Assistance</h5>
                    <p class="card-text-5">Need an extra pair of hands to manage your busy schedule? Our personal assistants can provide administrative support, schedule appointments, manage travel arrangements, and handle various tasks to streamline your life.</p>
                </div>
            </div>
        </div>
    </div>
